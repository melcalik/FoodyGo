...
public class AppDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Restaurant>().HasData(
            ...
            new Restaurant { Id = r2Id, Name = "Anne Elinden", Category = "homemade", Address = "Moda Cad. No:55, Kadıköy", Rating = 4.6, ReviewCount = 89, Distance = "1.2 km", DeliveryTime = "19:30 - 21:00", ImageUrl = "homemade.png", CreatedAt = fixedDate },
            ...
            new Restaurant { Id = r5Id, Name = "Usta Dönerci", Category = "kebab", Address = "Bağlarbaşı Mah. No:3, Üsküdar", Rating = 4.9, ReviewCount = 308, Distance = "1.7 km", DeliveryTime = "18:00 - 20:00", ImageUrl = "kebab.png", CreatedAt = fixedDate },
            new Restaurant { Id = r6Id, Name = "Güllüoğlu Baklava", Category = "sweet", Address = "Karaköy Mah. No:3, Beyoğlu", Rating = 4.9, ReviewCount = 421, Distance = "4.2 km", DeliveryTime = "20:30 - 22:30", ImageUrl = "sweet.png", CreatedAt = fixedDate }
        );
